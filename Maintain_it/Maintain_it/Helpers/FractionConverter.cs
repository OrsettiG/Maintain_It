...
{
    //Written by Patrick Harris and taken from https://www.codeproject.com/Tips/623477/Convert-Decimal-to-Fraction-and-Vice-Versa-in-Csha Licensed under CPOL
    public static class FractionConverter
    {
        ...
        bool skip_rounding = false, decimal dplaces = (decimal)0.0625 )
        {
            ...
            if( mFraction > 0m )
            {
                ...
                _ = mBuilder.Append( mDenomenator );
                _ = mBuilder.Append( "/" );
                _ = mBuilder.Append( mNumerator );
            }
        ...
        {
            string sPlaces = Convert(places, true);
