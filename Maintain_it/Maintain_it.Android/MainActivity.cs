    ...
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
    {
        ...
        private void ScheduleNotificationJobService()
        {
            ...
            if( jobScheduler.GetPendingJob( (int)Config.JobServiceIds.Notification ) == null )
            {
                ...
                // Set the service to run every 6 hours and persist through restarts
                _ = builder.SetPeriodic( (int)Config.MilliTimeIntervals.Hour * 6, (int)Config.MilliTimeIntervals.Hour ).SetPersisted( true );
